...
import SearchMember from "../structures/SearchMember";
interface IProps {
    isMinimized: boolean;
...
export default class LeftPanel extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        const viewHeight = window.outerHeight * 58/100;
        const SearchMember = sdk.getComponent("structures.SearchMember");
        return (
                ...
                <aside className="mx_LeftPanel_roomListContainer">
                    ...
                    <Tabs>
                        ...
                        <TabPanel>
                            ...
                            <div className="mx_LeftPanel_roomListWrapper" style={{ overflow: 'scroll',height:viewHeight}}>
                                <div
                        ...
                        <TabPanel>
                            <SearchMember isMinimized={this.props.isMinimized} />
                        </TabPanel>
                    </Tabs>
