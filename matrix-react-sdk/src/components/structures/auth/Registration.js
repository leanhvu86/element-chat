...
export default createReactClass({
    ...
    _makeRegisterRequest: function(auth) {
        ...
        const registerParams = {
            ...
            dateOfBirth: this.state.formVals.dateOfBirth,
    ...
    renderRegisterComponent() {
        ...
        if (this.state.matrixClient && this.state.doingUIAuth) {
            ...
            return <RegistrationForm
                ...
                defaultFirstname={this.state.formVals.firstname}
                defaultLastname={this.state.formVals.lastname}
                defaultBirthday={this.state.formVals.birthday}
                defaultEmail={this.state.formVals.email}
                defaultGender={this.state.formVals.gender}
