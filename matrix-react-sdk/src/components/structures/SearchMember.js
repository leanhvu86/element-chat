...
import AccessibleTooltipButton from "../../../lib/components/views/elements/AccessibleTooltipButton";
...
export default class SearchMember extends  React.PureComponent<IProps, IState>{
    static propTypes = {
    ...
    _startDm = async (targetId) => {
        ...
        //mới
        console.log('end point',targetIds);
        // const targetIds = member;
        ...
        // TODO: Tạm thời k tạo encrypt phòng khi config trong file config.json. đợi server
        if (privateShouldBeEncrypted()&& SdkConfig.get()['encryptRoomAvailable']) {
    ...
    _toggleMember = (member: Member) => {
        ...
        //     // cũ
        //     // filterText = "";
        //     // clear the filter when the user accepts a suggestion
        // }
        // this.setState({targets, filterText});
        this._startDm(member.userId);
        console.log('_toggleMember',member);
    };
    ...
    _renderEditor() {
        ...
        const classes = classNames({
            'mx_RoomSearch': true,
            // 'mx_RoomSearch_expanded': true,
            // 'mx_RoomSearch_minimized': this.props.isMinimized,
        });

        const inputClasses = classNames({
            'mx_RoomSearch_input': true,
            // 'mx_RoomSearch_inputExpanded': true,
        });
        ...
        const input = (
            <input style={{ border:'none',width:'80% !important',outline: 'none'}}
                ...
                placeholder={_t("Search friends")}
                autoComplete="off"
            />
        );
        return (
            <div className='mx_RoomSearch' onClick={this._onClickInputArea} >
                {targets}
    ...
    render() {
        ...
        const viewHeight = window.outerHeight * 65/100;
        return (<div className='mx_InviteDialog_content'>
                    ...
                    <div className='mx_InviteDialog_userSections' style={{height:viewHeight}}>
