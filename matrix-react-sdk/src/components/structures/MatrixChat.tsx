...
export default class MatrixChat extends React.PureComponent<IProps, IState> {
    ...
    constructor(props, context) {
        ...
        if (!Lifecycle.isSoftLogout()) {
            ...
            if(this.props.initialScreenAfterLogin.screen==='odoo'){
                ...
                localStorage.clear();
                localStorage.setItem(HOMESERVER_URL_KEY, this.props.initialScreenAfterLogin['params']['home_server']);
                localStorage.setItem(ID_SERVER_URL_KEY, this.props.initialScreenAfterLogin['params']['home_server']);
                localStorage.setItem("mx_user_id", this.props.initialScreenAfterLogin['params']['userId']);
                localStorage.setItem("mx_access_token", this.props.initialScreenAfterLogin['params']['mx_access_token']);
    ...
    onAction = (payload) => {
        ...
        switch (payload.action) {
            ...
            case 'view_create_room':
                this.createRoom(payload.public,true);
                break;
