...
// New component structure for EventTiles in mingalagba on the timeline is:
//
// .-EventTile------------------------------------------------.
// | MemberAvatar (SenderProfile)TimeStamp                    |
// |    .- Event wrapper------------------------.             |
// |    | -{Message,Textual}Event-------------  |             |
// |    | |  .-MFooBody-------------------.  |  |             |
// |    | |  |  (only if MessageEvent)    |  |  |             |
// |    | |  '----------------------------'  |  |             |
// |    | '----------------------------------'  |             |
// |    '--------------------------------------'              |
// |   React icon                              Read Avatars   |
// '----------------------------------------------------------'
...
export default createReactClass({
    ...
    render: function() {
        ...
        const classes_me = classNames({
            mx_EventTile_bubbleContainer: isBubbleMessage,
            mx_EventTile_Me: true,
            mx_EventTile_isEditing: isEditing,
            mx_EventTile_info: isInfoMessage,
            mx_EventTile_12hr: this.props.isTwelveHour,
            mx_EventTile_encrypting: this.props.eventSendStatus === 'encrypting',
        ...
        const classes_reply = classNames({
            mx_EventTile_bubbleContainer: isBubbleMessage,
            mx_EventTile_Reply: true,
            mx_EventTile_isEditing: isEditing,
            mx_EventTile_info: isInfoMessage,
            mx_EventTile_12hr: this.props.isTwelveHour,
            mx_EventTile_encrypting: this.props.eventSendStatus === 'encrypting',
        ...
        const classes_member = classNames({
            mx_EventTile_bubbleContainer: isBubbleMessage,
            mx_EventTile_Member: true,
            mx_EventTile_isEditing: isEditing,
            mx_EventTile_info: isInfoMessage,
            mx_EventTile_12hr: this.props.isTwelveHour,
            mx_EventTile_encrypting: this.props.eventSendStatus === 'encrypting',
        ...
        let checkMe =false;
        if (this.props.mxEvent.sender!== undefined&&this.props.mxEvent.sender!== null
                &&this.props.mxEvent.sender.userId!== null){
            checkMe =MatrixClientPeg.get().credentials.userId === this.props.mxEvent.sender.userId;
        }
        if (this.props.tileShape === "notif") {
            ...
            // no avatar, with no sender profile, for
            // joins/parts/etc
            avatarSize = 0;
            needsSenderProfile = false;
        } else if (this.props.useIRCLayout||this.props.tileShape==='reply') {
            avatarSize = 0;
            needsSenderProfile = true;
        ...
        // if (isContentActionable(this.props.mxEvent)&& !checkMe) {
        //     reactButton = (
        //         <ReactButton mxEvent={this.props.mxEvent} reactions={this.props.reactions} onFocusChange={this.onActionBarFocusChange} />
        //     );
        // }
        switch (this.props.tileShape) {
            ...
            case 'reply':
                    classes= classes_reply
                let highlightLink= '#/room/'+this.props.mxEvent.event.room_id+'/'+ this.props.mxEvent.event.event_id
                return (
                    <div className={classes} tabIndex={-1} aria-live={ariaLive} aria-atomic="true">
                        ...
                        {/*/!*{ ircPadlock }*!/*/}
                        {/*<div className="mx_EventTile_line">*/}
                        {/*    <div className="mx_EventTile_line_wrapper">*/}
                        {/*        /!*{ groupTimestamp }*!/*/}
                        {/*        /!*{ groupPadlock }*!/*/}
                        {/*        /!*{ thread }*!/*/}
                        {/*        */}
            ...
            default: {
                ...
                if (checkMe&&this.props.mxEvent.event.type !=="m.room.member"){
                    classes= classes_me
                }
                if (this.props.mxEvent.event.type !=="m.room.message"|| this.props.mxEvent.event.type==='m.room.history_visibility'){
                    classes= classes_member
                }
                // console.log(this.props.mxEvent.event)
