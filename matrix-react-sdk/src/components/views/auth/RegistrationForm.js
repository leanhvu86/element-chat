...
export default createReactClass({
    ...
    propTypes: {
        ...
        defaultBirthday: PropTypes.string,
    ...
    _doSubmit: function (ev) {
        ...
        const promise = this.props.onRegisterClick({
            ...
            display_name: this.state.lastname.trim() + ' '+this.state.firstname.trim(),
    ...
    async onFirstnameValidate(fieldState) {
        const result = await this.validateNameRules(fieldState);
        this.markFieldValid(FIELD_FIRSTNAME, result.valid);
        return result;
    },
    ...
    renderFirstname() {
        const Field = sdk.getComponent('elements.Field');
        return <Field
            id="mx_RegistrationForm_firstname"
            ref={field => this[FIELD_FIRSTNAME] = field}
            type="text"
            autoFocus={true}
            label={_t("Firstname")}
    ...
    renderLastname() {
        const Field = sdk.getComponent('elements.Field');
        return <Field
            id="mx_RegistrationForm_lastname"
    ...
    renderBirthday() {
        const Field = sdk.getComponent('elements.Field');
        return <Field
            id="mx_RegistrationForm_birthday"
    ...
    renderGender() {
        return (
            <div className="mx_ThemeSelectors">
                <input type="radio" value="male" name="gender" defaultChecked onChange={this.onGenderChange}/> {_t("Male")}
                <input type="radio" value="female" name="gender" onChange={this.onGenderChange}/> {_t("Female")}
                <input type="radio" value="other" name="gender"onChange={this.onGenderChange}/> {_t("Other")}
            </div>
        );
    },
    render: function () {
