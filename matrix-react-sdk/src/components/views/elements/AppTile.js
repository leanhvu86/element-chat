...
export default class AppTile extends React.Component {
    ...
    */
    ...
    _setupWidgetMessaging() {
        ...
        console.log('_getRenderedUrl', this._getRenderedUrl());
    ...
    formatAppTileName() {
        ...
        } else if (this.props.app.name.trim()==='Jitsi') {
          appTileName= _t("Group call running");
        }
        console.log('this.props.app.name', this.props.app.name)
        return appTileName;
    }
    ...
    _templatedUrl(u, widgetType: string) {
        ...
        if (WidgetType.JITSI.matches(widgetType)) {
            targetData['domain'] = 'jitsi.aggregatoricapaci.com'; // v1 jitsi widgets have this hardcoded
        }
        ...
        console.log('matrix_display_name', vars);

        if (vars.confId === undefined) {
            // we'll need to parse the conference ID out of the URL for v1 Jitsi widgets
            const parsedUrl = new URL(this.props.app.url);
            vars.confId = parsedUrl.searchParams.get("confId");
        }
    ...
    _getPopoutUrl() {
        console.log('_getPopoutUrl',this.props)
        if (WidgetType.JITSI.matches(this.props.app.type)) {
