...
MatrixClient.prototype.requestPasswordPhoneToken = function(country,phone, clientSecret,
                                                            sendAttempt, nextLink) {
    return this._requestTokenFromEndpoint(
        "/phonenumber/3pid/msisdn/requestToken",
        {
            country:country,
            phone_number: phone,
            client_secret: clientSecret,
...
MatrixClient.prototype.requestChangePasswordNew = function(phone,otp,new_password,sid, clientSecret, sendAttempt) {

    return this._http.authedRequest(
        undefined, // callback
        "POST",
        "/reset_password/msisdn/submit_token_v2",
        undefined,
        {
...
MatrixClient.prototype.requestPhoneAndGender = function() {
    const self = this;
    const path = utils.encodeUri("/_matrix/client/r0/profile/$userId/dateofbirthandgender", {
        $userId: this.credentials.userId,
    });
    return this._http.authedRequest(
        undefined, // callback
...
MatrixClient.prototype.requestEncryptionKey = function() {
    const self = this;
    const path = utils.encodeUri("/_matrix/client/r0/user_ec/$userId/encryption_key", {
        $userId: this.credentials.userId,
    });
    return this._http.authedRequest(
        undefined, // callback
...
MatrixClient.prototype.requestSaveEncryptionKey = function(encryption_key) {
    const path = utils.encodeUri("/user_ec/$userId/encryption_key", {
        $userId: this.credentials.userId,
    });
    return this._http.authedRequest(
        undefined, // callback
...
MatrixClient.prototype.setGender = function(content) {
    const self = this;
    const path = utils.encodeUri("/_matrix/client/r0/profile/$userId/gender", {
        $userId: this.credentials.userId,
    });
    return this._http.authedRequest(
        undefined, // callback
...
MatrixClient.prototype.setBirthday= function(content) {
    const self = this;
    const path = utils.encodeUri("/_matrix/client/r0/profile/$userId/dateofbirthandgender", {
        $userId: this.credentials.userId,
    });
