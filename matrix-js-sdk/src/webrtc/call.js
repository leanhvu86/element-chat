...
MatrixCall.prototype._gotLocalOffer = function(description) {
    ...
    self.peerConn.setLocalDescription(description, function() {
        ...
        logger.info('send invite',content)
...
const sendEvent = function(self, eventType, content) {
    logger.info('sendEvent',self)
    logger.info('sendEvent',eventType)
    logger.info('sendEvent',content)
...
const _sendCandidateQueue = function(self) {
    ...
    logger.info('cadidate send event', content)
